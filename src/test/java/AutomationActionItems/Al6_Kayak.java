...
public class Al6_Kayak {
    ...
    @Test public void KayakTestCase() throws InterruptedException, WriteException {
        ...
        for(int i=1; i<rows;i++) {
            ...
            Reusable_Library.clickByIndex(driver, "//*[text()='View Deal']", 0, "car deals");
            ...
            String message = Reusable_Library.captureText(driver, "(//*[contains(@class,'Checkout-Common-Baselayout-R')or (@class='bui-panel   ') ])[5]", "vehicleInfo");
